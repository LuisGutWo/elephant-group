          ...
          <div className="col-lg-4 col-md-6">
            <div className="item-serv md-mb50">
              <div className="d-flex align-items-center pb-20 mb-30 bord-thin-bottom">
                ...
                <div>
                  <h6>Diseños de productos</h6>
                </div>
              </div>
              <p className="fz-14">
                Creamos digitalmente todo lo que necesites para tu empresa, ya
                sea para versión web o impresión.
              </p>
            </div>
          </div>
          <div className="col-lg-4 col-md-6">
            <div className="item-serv md-mb50">
              <div className="d-flex align-items-center pb-20 mb-30 bord-thin-bottom">
                ...
                <div>
                  <h6>Branding & Publicidad</h6>
                </div>
              </div>
              <p className="fz-14">
                Te asesoramos a dar forma y dirección a tus ideas, .
              </p>
            </div>
          </div>
          <div className="col-lg-4 col-md-6">
            <div className="item-serv">
              ...
              <p className="fz-14">
                En nuestra área de impresión y producción podemos entregar un
                producto final de calidad y personalizado.
              </p>
            </div>
          </div>
        </div>
